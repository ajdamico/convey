...
test_that( "svywattsdec works on unweighted designs" , {
  expect_false( anyNA( coef( svywattsdec( ~api00, design=dstrat1 , abs_thresh = 600 , type_thresh = "abs" ) ) ) )
  expect_false( anyNA ( SE( svywattsdec( ~api00, design=dstrat1 , abs_thresh = 600 , type_thresh = "abs" ) ) ) )
} )
...
# calculate estimates
a1 <- svywattsdec( ~eqincome , des_eusilc , abs_thresh = 7000 , type_thresh = "abs" )
a2 <- svyby( ~eqincome , ~hsize, des_eusilc , svywattsdec , abs_thresh = 7000 , type_thresh = "abs" )
b1 <- svywattsdec( ~eqincome , des_eusilc_rep , abs_thresh = 7000 , type_thresh = "abs" )
b2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svywattsdec , abs_thresh = 7000 , type_thresh = "abs" )
d1 <- svywatts( ~eqincome , des_eusilc , abs_thresh = 7000 , type_thresh = "abs" )
d2 <- svyby( ~eqincome , ~hsize, des_eusilc , svywatts , abs_thresh = 7000 , type_thresh = "abs" )
e1 <- svywatts( ~eqincome , des_eusilc_rep , abs_thresh = 7000 , type_thresh = "abs" )
e2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svywatts , abs_thresh = 7000 , type_thresh = "abs" )
...
test_that("database svywattsdec",{
  ...
  # calculate estimates
  c1 <- svywattsdec( ~eqincome , dbd_eusilc , abs_thresh = 7000 , type_thresh = "abs" )
  c2 <- svyby( ~eqincome , ~hsize, dbd_eusilc , svywattsdec , abs_thresh = 7000 , type_thresh = "abs" )
...
# calculate estimates
sub_des <- svywattsdec( ~eqincome , design = subset( des_eusilc , hsize == 1) , abs_thresh = 7000 , type_thresh = "abs" )
sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svywattsdec , abs_thresh = 7000 , type_thresh = "abs" )
sub_rep <- svywattsdec( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , abs_thresh = 7000 , type_thresh = "abs" )
sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svywattsdec , abs_thresh = 7000 , type_thresh = "abs" )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svywattsdec( ~eqincome , design = subset( dbd_eusilc , hsize == 1) , abs_thresh = 7000 , type_thresh = "abs" )
  sby_dbd <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc, FUN = svywattsdec , abs_thresh = 7000 , type_thresh = "abs" )
  sub_dbr <- svywattsdec( ~eqincome , design = subset( dbd_eusilc_rep , hsize == 1) , abs_thresh = 7000 , type_thresh = "abs" )
  sby_dbr <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc_rep, FUN = svywattsdec , abs_thresh = 7000 , type_thresh = "abs" )

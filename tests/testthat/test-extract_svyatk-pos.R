...
sub_des <-
  svyatk(~ eqincome , design = subset(des_eusilc , hsize == 1))
sby_des <-
  svyby(~ eqincome,
        by = ~ hsize,
        design = des_eusilc,
        FUN = svyatk)
sub_rep <-
  svyatk(~ eqincome , design = subset(des_eusilc_rep , hsize == 1))
sby_rep <-
  svyby(~ eqincome,
        by = ~ hsize,
        design = des_eusilc_rep,
...
sub_dbd <-
  svyatk(~ eqincome , design = subset(dbd_eusilc , hsize == 1))
sby_dbd <-
  svyby(~ eqincome,
        by = ~ hsize,
        design = dbd_eusilc,
        FUN = svyatk)
sub_dbr <-
  svyatk(~ eqincome , design = subset(dbd_eusilc_rep , hsize == 1))
sby_dbr <-
  svyby(~ eqincome,
        by = ~ hsize,

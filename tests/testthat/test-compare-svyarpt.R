...
fun_arptw <- svyarpt( ~eqincome , des_eusilc, 0.5 , 0.6 )
fun_arptw_rep <- svyarpt( ~eqincome , des_eusilc_rep, 0.5 , 0.6 )
...
# calculate estimates
fun_arptd <- svyby( ~eqincome , ~hsize , des_eusilc , svyarpt , quantiles = 0.5 , percent = 0.6 , deff = FALSE )

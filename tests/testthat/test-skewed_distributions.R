...
test_that("functions work on weird distributions" ,{
  ...
  all_funs <- c( "svyrmir" , "svyqsr" , "svyarpt" , "svyarpt" , "svyatk" , "svyfgt" , "svygini" , "svygpg" , "svyiqalpha" , "svyisq" , "svyzenga" , "svypoormed" , "svyrenyi" , "svygei" , "svyrmpg" , "svyzengacurve" , "svylorenz" , "svyjdiv" , "svyamato" , "svysst" , "svysen" , "svyrich" , "svychu" , "svywatts" )
    ...
    for( this_function in all_funs ){
      ...
      for( this_prefix in c( 'unwtd' , 'binom' , 'unif' ) ){
        ...
        for( this_formula in list( ~ beta_050_050 , ~ beta_500_100 , ~ beta_100_300 , ~ beta_200_200 , ~ beta_200_500 , ~ pois1 , ~ pois100 ) ){
          ...
          if( any( unlist( lapply( list( svygei , svyrenyi , svyamato , svyatk , svyjdiv , svyzenga ) , function( z ) identical( z , FUN ) ) ) ) ){

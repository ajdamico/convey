...
c1 <- svysen( ~eqincome, design=dbd_eusilc, abs_thresh = 15000, na.rm = FALSE )

c2 <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svysen, abs_thresh = 15000, deff = FALSE)


test_that("database svysen",{
...
sub_des <- svysen( ~eqincome, design = subset( des_eusilc, rb090 == "male"), abs_thresh = 15000, na.rm = FALSE )
sby_des <- svyby( ~eqincome, by = ~rb090, design = des_eusilc, FUN = svysen, abs_thresh = 15000, deff = FALSE)
sub_rep <- svysen( ~eqincome, design = subset( des_eusilc_rep, rb090 == "male"), abs_thresh = 15000, na.rm = FALSE )
sby_rep <- svyby( ~eqincome, by = ~rb090, design = des_eusilc_rep, FUN = svysen, abs_thresh = 15000, deff = FALSE)
...
sub_dbd <- svysen( ~eqincome, design = subset( dbd_eusilc, rb090 == "male"), abs_thresh = 15000, na.rm = FALSE )
sby_dbd <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svysen, abs_thresh = 15000, deff = FALSE)
sub_dbr <- svysen( ~eqincome, design = subset( dbd_eusilc_rep, rb090 == "male"), abs_thresh = 15000, na.rm = FALSE )
sby_dbr <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc_rep, FUN = svysen, abs_thresh = 15000, deff = FALSE)

...
a1 <- svywattsdec( ~eqincome, design=des_eusilc, abs_thresh = 15000, na.rm = FALSE )

a2 <- svyby( ~eqincome, by = ~rb090, design = des_eusilc, FUN = svywattsdec, abs_thresh = 15000, deff = FALSE)

b1 <- svywattsdec( ~eqincome, design=des_eusilc_rep, abs_thresh = 15000 , na.rm = FALSE )

b2 <- svyby( ~eqincome, by = ~rb090, design = des_eusilc_rep, FUN = svywattsdec, abs_thresh = 15000, deff = FALSE)
...
c1 <- svywattsdec( ~eqincome, design=dbd_eusilc, abs_thresh = 15000, na.rm = FALSE )
c2 <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svywattsdec, abs_thresh = 15000, deff = FALSE)
...
sub_des <- svywattsdec( ~eqincome, design = subset( des_eusilc, rb090 == "male"), abs_thresh = 15000, na.rm = FALSE )
sby_des <- svyby( ~eqincome, by = ~rb090, design = des_eusilc, FUN = svywattsdec, abs_thresh = 15000, deff = FALSE)
sub_rep <- svywattsdec( ~eqincome, design = subset( des_eusilc_rep, rb090 == "male"), abs_thresh = 15000, na.rm = FALSE )
sby_rep <- svyby( ~eqincome, by = ~rb090, design = des_eusilc_rep, FUN = svywattsdec, abs_thresh = 15000, deff = FALSE)
...
sub_dbd <- svywattsdec( ~eqincome, design = subset( dbd_eusilc, rb090 == "male"), abs_thresh = 15000, na.rm = FALSE )
sby_dbd <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svywattsdec, abs_thresh = 15000, deff = FALSE)
sub_dbr <- svywattsdec( ~eqincome, design = subset( dbd_eusilc_rep, rb090 == "male"), abs_thresh = 15000, na.rm = FALSE )
sby_dbr <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc_rep, FUN = svywattsdec, abs_thresh = 15000, deff = FALSE)

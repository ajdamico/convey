...
sby_des <- svyby( ~eqincome, by = ~db040, design = des_eusilc, FUN = svyfgt , g=0, type_thresh= "abs", abs_thresh=10000)
sub_rep <- svyfgt( ~eqincome , design = subset( des_eusilc_rep , db040 == "Burgenland" ), g=0, type_thresh= "abs", abs_thresh=10000 )
sby_rep <- svyby( ~eqincome, by = ~db040, design = des_eusilc_rep, FUN = svyfgt, g=0, type_thresh= "abs", abs_thresh=10000)
...
test_that("subsets equal svyby",{
  ...
  sub_dbd <- svyfgt( ~eqincome , design = subset( dbd_eusilc , db040 == "Burgenland" ), g=0, type_thresh= "abs", abs_thresh=10000 )
  sby_dbd <- svyby( ~eqincome, by = ~db040, design = dbd_eusilc, FUN = svyfgt ,g=0, type_thresh= "abs", abs_thresh=10000)

...
# return test context
context( "svyjdiv decomposition output survey.design and svyrep.design")
...
# calculate estimates
a1 <- svyjdivdec( ~eqincome , des_eusilc , subgroup = ~db040 , deff = TRUE )
a2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyjdivdec , subgroup = ~db040 , deff = TRUE )
b1 <- svyjdivdec( ~eqincome , des_eusilc_rep , subgroup = ~db040 , deff = TRUE )
b2 <- svyby( ~eqincome , ~rb090, des_eusilc_rep , svyjdivdec , subgroup = ~db040 , deff = TRUE )
...
test_that("database svyjdiv",{
  ...
  # calculate estimates
  c1 <- svyjdivdec( ~eqincome , dbd_eusilc , subgroup = ~db040 , deff = TRUE )
  c2 <- svyby( ~eqincome , ~rb090, dbd_eusilc , svyjdivdec , subgroup = ~db040 , deff = TRUE )
...
# calculate estimates
sub_des <- svyjdivdec( ~eqincome , design = subset( des_eusilc , rb090 == "male" ) , subgroup = ~db040 , deff = TRUE )
sby_des <- svyby( ~eqincome, by = ~rb090, design = des_eusilc, FUN = svyjdivdec , subgroup = ~db040 , deff = TRUE )
sub_rep <- svyjdivdec( ~eqincome , design = subset( des_eusilc_rep , rb090 == "male" ) , subgroup = ~db040 , deff = TRUE )
sby_rep <- svyby( ~eqincome, by = ~rb090, design = des_eusilc_rep, FUN = svyjdivdec , subgroup = ~db040 , deff = TRUE )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svyjdivdec( ~eqincome , design = subset( dbd_eusilc , rb090 == "male" ) , subgroup = ~db040 , deff = TRUE )
  sby_dbd <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svyjdivdec , subgroup = ~db040 , deff = TRUE )
  sub_dbr <- svyjdivdec( ~eqincome , design = subset( dbd_eusilc_rep , rb090 == "male" ) , subgroup = ~db040 , deff = TRUE )
  sby_dbr <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc_rep, FUN = svyjdivdec , subgroup = ~db040 , deff = TRUE )

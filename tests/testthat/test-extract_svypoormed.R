...
sub_des <- svypoormed( ~eqincome , design = subset( des_eusilc , db040 == "Burgenland" ) )
sby_des <- svyby( ~eqincome, by = ~db040, design = des_eusilc, FUN = svypoormed)
sub_rep <- svypoormed( ~eqincome , design = subset( des_eusilc_rep , db040 == "Burgenland" ) )
sby_rep <- svyby( ~eqincome, by = ~db040, design = des_eusilc_rep, FUN = svypoormed)
...
if( .Machine$sizeof.pointer > 4 ){
  ...
  sub_dbd <- svypoormed( ~eqincome , design = subset( dbd_eusilc , db040 == "Burgenland" ) )
  sby_dbd <- svyby( ~eqincome, by = ~db040, design = dbd_eusilc, FUN = svypoormed)
  sub_dbr <- svypoormed( ~eqincome , design = subset( dbd_eusilc_rep , db040 == "Burgenland" ) )
  sby_dbr <- svyby( ~eqincome, by = ~db040, design = dbd_eusilc_rep, FUN = svypoormed)

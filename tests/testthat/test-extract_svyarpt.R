...
sub_des <-
  svyarpt(~ eqincome , design = subset(des_eusilc , hsize == 1))
sby_des <-
  svyby(~ eqincome,
        by = ~ hsize,
        design = des_eusilc,
        FUN = svyarpt)
sub_rep <-
  svyarpt(~ eqincome , design = subset(des_eusilc_rep , hsize == 1))
sby_rep <-
  svyby(~ eqincome,
        by = ~ hsize,
        design = des_eusilc_rep,
...
sub_dbd <-
  svyarpt(~ eqincome , design = subset(dbd_eusilc , hsize == 1))
sby_dbd <-
  svyby(~ eqincome,
        by = ~ hsize,
        design = dbd_eusilc,
        FUN = svyarpt)
sub_dbr <-
  svyarpt(~ eqincome , design = subset(dbd_eusilc_rep , hsize == 1))
sby_dbr <-
  svyby(~ eqincome,
        by = ~ hsize,

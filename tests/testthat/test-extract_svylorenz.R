...
sub_des <-
  svylorenz( ~ eqincome , design = subset(des_eusilc , db040 == "Burgenland"))
sby_des <-
  svyby( ~ eqincome,
         by = ~ db040,
         design = des_eusilc,
         FUN = svylorenz)
sub_rep <-
  svylorenz( ~ eqincome , design = subset(des_eusilc_rep , db040 == "Burgenland"))
sby_rep <-
  svyby( ~ eqincome,
         by = ~ db040,
         design = des_eusilc_rep,
...
sub_dbd <-
  svylorenz( ~ eqincome , design = subset(dbd_eusilc , db040 == "Burgenland"))
sby_dbd <-
  svyby( ~ eqincome,
         by = ~ db040,
         design = dbd_eusilc,
         FUN = svylorenz)
sub_dbr <-
  svylorenz( ~ eqincome , design = subset(dbd_eusilc_rep , db040 == "Burgenland"))
sby_dbr <-
  svyby( ~ eqincome,
         by = ~ db040,

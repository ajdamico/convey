...
sub_des <- svylorenz( ~eqincome , design = subset( des_eusilc , db040 == "Burgenland") )
sby_des <- svyby( ~eqincome, by = ~db040, design = des_eusilc, FUN = svylorenz)
sub_rep <- svylorenz( ~eqincome , design = subset( des_eusilc_rep , db040 == "Burgenland") )

...
test_that( "svywattsdec works on unweighted designs" , {
  expect_false( anyNA( coef( svywattsdec( ~api00, design=dstrat1 , percent = .8 , type_thresh = "relm" ) ) ) )
  expect_false( anyNA ( SE( svywattsdec( ~api00, design=dstrat1 , percent = .8 , type_thresh = "relm" ) ) ) )
} )
...
a2 <- svyby( ~eqincome , ~hsize, des_eusilc , svywattsdec , type_thresh = "relm" )
b1 <- svywattsdec( ~eqincome , des_eusilc_rep , type_thresh = "relm" )
b2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svywattsdec , type_thresh = "relm" )
d1 <- svywatts( ~eqincome , des_eusilc , type_thresh = "relm" )
d2 <- svyby( ~eqincome , ~hsize, des_eusilc , svywatts , type_thresh = "relm" )
e1 <- svywatts( ~eqincome , des_eusilc_rep , type_thresh = "relm" )
e2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svywatts , type_thresh = "relm" )
...
test_that("database svywattsdec",{
  ...
  c2 <- svyby( ~eqincome , ~hsize, dbd_eusilc , svywattsdec , type_thresh = "relm" )
...
# calculate estimates
sub_des <- svywattsdec( ~eqincome , design = subset( des_eusilc , hsize == 1) , type_thresh = "relm" )
sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svywattsdec , type_thresh = "relm" )
sub_rep <- svywattsdec( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , type_thresh = "relm" )
sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svywattsdec , type_thresh = "relm" )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svywattsdec( ~eqincome , design = subset( dbd_eusilc , hsize == 1) , type_thresh = "relm" )
  sby_dbd <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc, FUN = svywattsdec , type_thresh = "relm" )
  sub_dbr <- svywattsdec( ~eqincome , design = subset( dbd_eusilc_rep , hsize == 1) , type_thresh = "relm" )
  sby_dbr <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc_rep, FUN = svywattsdec , type_thresh = "relm" )

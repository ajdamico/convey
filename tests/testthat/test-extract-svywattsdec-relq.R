...
# return test context
context( "svywattsdec-relq output survey.design and svyrep.design" )
...
test_that( "svywattsdec works on unweighted designs" , {
  expect_false( anyNA( coef( svywattsdec( ~api00, design=dstrat1 , percent = .8 , type_thresh = "relq" ) ) ) )
  expect_false( anyNA ( SE( svywattsdec( ~api00, design=dstrat1 , percent = .8 , type_thresh = "relq" ) ) ) )
} )
...
# calculate estimates
a1 <- svywattsdec( ~eqincome , des_eusilc , type_thresh = "relq" )
a2 <- svyby( ~eqincome , ~hsize, des_eusilc , svywattsdec , type_thresh = "relq" )
b1 <- svywattsdec( ~eqincome , des_eusilc_rep , type_thresh = "relq" )
b2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svywattsdec , type_thresh = "relq" )
d1 <- svywatts( ~eqincome , des_eusilc , type_thresh = "relq" )
d2 <- svyby( ~eqincome , ~hsize, des_eusilc , svywatts , type_thresh = "relq" )
e1 <- svywatts( ~eqincome , des_eusilc_rep , type_thresh = "relq" )
e2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svywatts , type_thresh = "relq" )
...
test_that("database svywattsdec",{
  ...
  # calculate estimates
  c1 <- svywattsdec( ~eqincome , dbd_eusilc , type_thresh = "relq" )
  c2 <- svyby( ~eqincome , ~hsize, dbd_eusilc , svywattsdec , type_thresh = "relq" )
...
# calculate estimates
sub_des <- svywattsdec( ~eqincome , design = subset( des_eusilc , hsize == 1) , type_thresh = "relq" )
sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svywattsdec , type_thresh = "relq" )
sub_rep <- svywattsdec( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , type_thresh = "relq" )
sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svywattsdec , type_thresh = "relq" )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svywattsdec( ~eqincome , design = subset( dbd_eusilc , hsize == 1) , type_thresh = "relq" )
  sby_dbd <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc, FUN = svywattsdec , type_thresh = "relq" )
  sub_dbr <- svywattsdec( ~eqincome , design = subset( dbd_eusilc_rep , hsize == 1) , type_thresh = "relq" )
  sby_dbr <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc_rep, FUN = svywattsdec , type_thresh = "relq" )

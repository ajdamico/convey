...
a2 <-
  svyby(~ eqincome , ~ hsize, des_eusilc , svywattsdec , type_thresh = "relq")
b1 <-
  svywattsdec(~ eqincome , des_eusilc_rep , type_thresh = "relq")
b2 <-
  svyby(~ eqincome , ~ hsize, des_eusilc_rep , svywattsdec , type_thresh = "relq")
d1 <- svywatts(~ eqincome , des_eusilc , type_thresh = "relq")
d2 <-
  svyby(~ eqincome , ~ hsize, des_eusilc , svywatts , type_thresh = "relq")
e1 <- svywatts(~ eqincome , des_eusilc_rep , type_thresh = "relq")
e2 <-
  svyby(~ eqincome , ~ hsize, des_eusilc_rep , svywatts , type_thresh = "relq")
...
test_that("database svywattsdec", {
  ...
  c2 <-
    svyby(~ eqincome , ~ hsize, dbd_eusilc , svywattsdec , type_thresh = "relq")

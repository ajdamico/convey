...
for (this_g in 1:2 ) {
  ...
  test_that("svyfgtdec works on unweighted designs",{
    svyfgtdec( ~api00, design=dstrat1, g = this_g , abs_thresh = 700, na.rm = FALSE )
  })
...
for (this_g in 1:2 ) {
  ...
  a1 <- svyfgtdec( ~eqincome, design=des_eusilc, g = this_g , abs_thresh = 15000, na.rm = FALSE )
  a2 <- svyby( ~eqincome, by = ~rb090, design = des_eusilc, FUN = svyfgtdec, g = this_g ,abs_thresh = 15000, deff = FALSE)
  b1 <- svyfgtdec( ~eqincome, design=des_eusilc_rep, g = this_g ,abs_thresh = 15000 , na.rm = FALSE )
  b2 <- svyby( ~eqincome, by = ~rb090, design = des_eusilc_rep, FUN = svyfgtdec, g = this_g ,abs_thresh = 15000, deff = FALSE)
  ...
  c1 <- svyfgtdec( ~eqincome, design=dbd_eusilc, g = this_g , abs_thresh = 15000, na.rm = FALSE )
  c2 <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svyfgtdec, g = this_g ,abs_thresh = 15000, deff = FALSE)
  ...
  sub_des <- svyfgtdec( ~eqincome, design = subset( des_eusilc, rb090 == "male"), g = this_g ,abs_thresh = 15000, na.rm = FALSE )
  sby_des <- svyby( ~eqincome, by = ~rb090, design = des_eusilc, FUN = svyfgtdec, g = this_g ,abs_thresh = 15000, deff = FALSE)
  sub_rep <- svyfgtdec( ~eqincome, design = subset( des_eusilc_rep, rb090 == "male"), g = this_g ,abs_thresh = 15000, na.rm = FALSE )
  sby_rep <- svyby( ~eqincome, by = ~rb090, design = des_eusilc_rep, FUN = svyfgtdec, g = this_g ,abs_thresh = 15000, deff = FALSE)
  ...
  sub_dbd <- svyfgtdec( ~eqincome, design = subset( dbd_eusilc, rb090 == "male"), g = this_g ,abs_thresh = 15000, na.rm = FALSE )
  sby_dbd <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svyfgtdec, g = this_g ,abs_thresh = 15000, deff = FALSE)
  sub_dbr <- svyfgtdec( ~eqincome, design = subset( dbd_eusilc_rep, rb090 == "male"), g = this_g ,abs_thresh = 15000, na.rm = FALSE )
  sby_dbr <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc_rep, FUN = svyfgtdec, g = this_g ,abs_thresh = 15000, deff = FALSE)

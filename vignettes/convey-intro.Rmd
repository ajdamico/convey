...
In the library convey, there are some basic functions that produces the linearized variables of some estimates that often enter in the definition of measures of concentration and poverty. For example the `quantile` which is linearized by the function `iqalpha`. Other example is the function `isq` that linearizes the total below a quantile of the variable.
